...
i = Incrementer(0)
test = NodeList(10)
print 'when n = 0: ', i.count
test.append(1)
print 'when n = 1: ', i.count - 0
test.append(2)
print 'when n = 2: ', i.count - 1
test.append(3)
print 'when n = 3: ', i.count - 3
test.append(45)
print 'when n = 4: ', i.count - 6
test.append(6)
print 'when n = 5: ', i.count - 10
test.append(9)
print 'when n = 6: ', i.count - 15
test.append(100)
print 'when n = 7: ', i.count - 21
...
print 'when n = 0: ', 0
print 'when n = 1: ', 1
print 'when n = 2: ', 2 * 2 * 1
print 'when n = 3: ', 2 * 2 * 2
print 'when n = 4: ', 2 * 2 * 2 * 2
print 'when n = 5: ', 2 * 2 * 2 * 2 * 2
...
print 'when n = 0: ', 0
print 'when n = 1: ', 1
print 'when n = 2: ', 2**1 + (1)
print 'when n = 3: ', 2**2 + (2**1 + 1)
print 'when n = 4: ', 2**3 + (2**2 + 2**1 + 1)
print 'when n = 5: ', 2**4 + (2**3 + 2**2 + 2**1 + 1)
