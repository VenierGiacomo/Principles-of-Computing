...
print 'when n = 0: ', add_up(0)
print 'when n = 1: ', add_up(1)
print 'when n = 2: ', add_up(2)
print 'when n = 3: ', add_up(3)
print 'when n = 4: ', add_up(4)
print 'when n = 5: ', add_up(5)
print 'when n = 6: ', add_up(6)
print 'when n = 7: ', add_up(7)
print 'when n = 8: ', add_up(8)
...
print 'when n = 0: ', multiply_up(0)
print 'when n = 1: ', multiply_up(1)
print 'when n = 2: ', multiply_up(2)
print 'when n = 3: ', multiply_up(3)
print 'when n = 4: ', multiply_up(4)
print 'when n = 5: ', multiply_up(5)
print 'when n = 6: ', multiply_up(6)
print 'when n = 7: ', multiply_up(7)
print 'when n = 8: ', multiply_up(8)
...
j = Incrementer(0)
fib(2)
print 'when n = 2: ', j.count
j = Incrementer(0)
fib(3)
print 'when n = 3: ', j.count
j = Incrementer(0)
fib(4)
print 'when n = 4: ', j.count
j = Incrementer(0)
fib(5)
print 'when n = 5: ', j.count
j = Incrementer(0)
fib(6)
print 'when n = 6: ', j.count
j = Incrementer(0)
fib(7)
print 'when n = 7: ', j.count
j = Incrementer(0)
fib(8)
print 'when n = 8: ', j.count
...
print 'when n = 0: ', k.count
k = Incrementer(0)
memoized_fib(1, {0 : 0, 1 : 1})
print 'when n = 1: ', k.count
k = Incrementer(0)
memoized_fib(2, {0 : 0, 1 : 1})
print 'when n = 2: ', k.count
k = Incrementer(0)
memoized_fib(3, {0 : 0, 1 : 1})
print 'when n = 3: ', k.count
k = Incrementer(0)
memoized_fib(4, {0 : 0, 1 : 1})
print 'when n = 4: ', k.count
k = Incrementer(0)
memoized_fib(5, {0 : 0, 1 : 1})
print 'when n = 5: ', k.count
k = Incrementer(0)
memoized_fib(6, {0 : 0, 1 : 1})
print 'when n = 6: ', k.count
k = Incrementer(0)
memoized_fib(7, {0 : 0, 1 : 1})
print 'when n = 7: ', k.count
...
l = Incrementer(0)
outcomes('a')
print 'when n = 1:', l.count
l = Incrementer(0)
outcomes('ab')
print 'when n = 2:', l.count
l = Incrementer(0)
outcomes('abc')
print 'when n = 3:', l.count
l = Incrementer(0)
outcomes('abcd')
print 'when n = 4:', l.count
l = Incrementer(0)
outcomes('abcde')
print 'when n = 5:', l.count
l = Incrementer(0)
outcomes('abcdef')
print 'when n = 6:', l.count
l = Incrementer(0)
outcomes('abcdefg')
print 'when n = 7:', l.count
