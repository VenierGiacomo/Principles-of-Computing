...
def resources_vs_time(upgrade_cost_increment, num_upgrade):
    ...
    [current_time, total_res_generated]
    '''
    resources = []
    total_res_generated = 0.0
    current_time = 0.0
    ...
    for item in xrange(num_upgrade):
        ...
        total_res_generated += growth * (current_resources / growth)
        current_resources += upgrade_cost_increment
        growth += 1
        resources.append([current_time, total_res_generated])
